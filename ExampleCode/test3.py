...
list_of_errors = [STP_average_error, GLD_average_error, SignOPT_average_error, SCOBO_average_error]
list_of_algorithms = ['STP', 'GLD', 'SignOPT', 'SCOBO']
...
path_name = "/Users/ishaslavin/Downloads/AVERAGE_CHART_oct21_research_under_dim100_DF.csv"
df.to_csv(path_name)
